...
enum class TemporalFaultReason : std::uint8_t {
  ...
  kImuStreamTimingJitterSuspicious,
  kLidarStreamTimingJitterSuspicious,
  kImuStreamTimingJitterHigh,
  kLidarStreamTimingJitterHigh,
  kImuStreamTimingGap,
  kLidarStreamTimingGap,
  kImuStreamTimingReordered,
  kLidarStreamTimingReordered,
